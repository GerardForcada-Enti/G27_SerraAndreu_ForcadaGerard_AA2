...
void Map::UpdateMap(InputData keyboard)
{
	...
	{ 
		if (this->m_players[0].GetPos().x <= 1) {}
		else if (this->m_map[m_players[0].GetPos().x][m_players[0].GetPos().y - 1] != 'X' || this->m_map[m_players[0].GetPos().x][m_players[0].GetPos().y - 1] != '*')
		{
	...
	{
		if (this->m_players[0].GetPos().x >= this->width - 2) {}
		else if (this->m_map[m_players[0].GetPos().x][m_players[0].GetPos().y + 1] != 'X' || this->m_map[m_players[0].GetPos().x][m_players[0].GetPos().y + 1] != '*')
		{
			this->m_map[m_players[0].GetPos().x][m_players[0].GetPos().y] = ' ';
	...
	{
		if (this->m_players[0].GetPos().y >= this->height - 2) {}
		else if (this->m_map[m_players[0].GetPos().x + 1][m_players[0].GetPos().y] != 'X' || this->m_map[m_players[0].GetPos().x + 1][m_players[0].GetPos().y] != '*')
		{
			this->m_map[m_players[0].GetPos().x][m_players[0].GetPos().y] = ' ';
	...
	{
		if (this->m_players[0].GetPos().y <= 1) {}
		else if (this->m_map[m_players[0].GetPos().x - 1][m_players[0].GetPos().y] != 'X' || this->m_map[m_players[0].GetPos().x - 1][m_players[0].GetPos().y] != '*')
		{
			this->m_map[m_players[0].GetPos().x][m_players[0].GetPos().y] = ' ';
	...
	{
		if (this->m_players[1].GetPos().x <= 1) {}
		else if (this->m_map[m_players[1].GetPos().x][m_players[1].GetPos().y - 1] != 'X' || this->m_map[m_players[1].GetPos().x][m_players[1].GetPos().y - 1] != '*')
		{
	...
	{
		if (this->m_players[1].GetPos().x >= this->width - 2) {}
		else if (this->m_map[m_players[1].GetPos().x][m_players[1].GetPos().y + 1] != 'X' || this->m_map[m_players[1].GetPos().x][m_players[1].GetPos().y + 1] != '*')
		{
			this->m_map[m_players[1].GetPos().x][m_players[1].GetPos().y] = ' ';
	...
	{
		if (this->m_players[1].GetPos().y >= this->height - 2) {}
		else if (this->m_map[m_players[1].GetPos().x + 1][m_players[1].GetPos().y] != 'X' || this->m_map[m_players[1].GetPos().x + 1][m_players[1].GetPos().y] != '*')
		{
			this->m_map[m_players[1].GetPos().x][m_players[1].GetPos().y] = ' ';
	...
	{
		if (this->m_players[1].GetPos().y <= 1) {}
		else if (this->m_map[m_players[1].GetPos().x - 1][m_players[1].GetPos().y] != 'X' || this->m_map[m_players[1].GetPos().x - 1][m_players[1].GetPos().y] != '*')
		{
			this->m_map[m_players[1].GetPos().x][m_players[1].GetPos().y] = ' ';
